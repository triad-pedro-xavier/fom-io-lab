...
const FotografiaFieldCustomComp = class extends Component {
  constructor(props) {
    ...
    this.galeriaLabel = React.createRef();
    this.verticalLabel = React.createRef();
  ...
  componentDidMount() {
    ...
    if (this.state.component.galeria) this.galeriaLabel.current.classList.remove('d-none');
    else this.galeriaLabel.current.classList.add('d-none');

    if (this.state.component.vertical) this.verticalLabel.current.classList.remove('d-none');
    else this.verticalLabel.current.classList.add('d-none');
    ...
    return (
      <div >
        <div className="d-flex" style={{ height: '30px', gap: '5px' }}>
          ...
          <i ref={this.galeriaLabel} class="bi bi-images"></i>
          <i ref={this.verticalLabel} class="bi bi-arrow-bar-up"></i>
